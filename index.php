  ...
  <body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#">ARSIP SURAT <span class="logo-dec">Desa Karangduren</span></a>
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="banner-info text-center wow fadeIn delay-05s">
              ...
              <h3 class="bnr-sub-title">E-ARSIP DESA KARANGDREN</h3>
                <h3 class="bnr-sub-title"><span class="logo-dec">DESA KARANGDUREN</span></h3>
            </div>
          </div>
        </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <h2 class="service-title pad-bt15">Tentang Sistem</h2>
            
            <p class="sub-title pad-bt15">Website ini berguna untuk pengarsipan Surat Masuk dan Surat Keluar di Desa Karangduren</p><p>Surat diarsipkan dalam format PDF lalu disesuaikan nomor urutnya.</p>
    ...
    <section id="portfolio" class="section-padding wow fadeInUp delay-05s">
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <h2 class="service-title pad-bt15">PROFIL</h2>
            <p class="sub-title pad-bt15">"ELSA APRELIANI SUTRISNO"</p>
            <hr class="bottom-line">
          </div>
          <div class="col-md-3"></div>
          <div class="col-md-6 col-sm-6 col-xs-12 portfolio-item padding-right-zero mr-btn-15">
            <figure>
              <img src="img/elsa.jpg" class="img-responsive">
              <figcaption>
                  <h2>ELSA APRELIANI SUTRISNO</h2>
                  <p>"1931710021"</p>
            ...
            <ul class="bxslider">
              <li>
                <blockquote>
                  ...
                  <p>Projek ini saya buat guna memenuhi tugas sertifikasi </p>
                </blockquote>
                <small>ELSA APRELIANI SUTRISNO/1931710021</small>
              </li>
